const Pricing = () => {
  return (
    <section className="py-32 container mx-auto px-6">
      ...
      {/* grid with items-stretch makes all child divs equal height */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
        
        {/* Starter Plan */}
        <div className="p-12 rounded-[45px] border border-gray-100 hover:border-purple-200 transition-all flex flex-col h-full bg-white shadow-sm hover:shadow-xl">
          ...
          <ul className="space-y-4 mb-12 text-gray-500 font-bold flex-grow">
          ...
          <button className="w-full py-4 rounded-2xl bg-[#7C3AED] text-white font-black hover:bg-[#6D28D9] transition-all">
            Get Started Free
          </button>
        </div>

        {/* Pro Plan */}
        <div className="p-12 rounded-[45px] bg-[#7C3AED] text-white shadow-3xl relative flex flex-col h-full transform scale-105 z-10">
          <span className="absolute -top-4 left-1/2 -translate-x-1/2 bg-yellow-300 text-black px-6 py-1.5 rounded-full text-[10px] font-black uppercase">
            Most Popular
          </span>
          ...
          <ul className="space-y-4 mb-12 font-bold flex-grow">
          ...
          <button className="w-full py-4 rounded-2xl bg-white text-[#7C3AED] font-black hover:bg-gray-100 transition-colors shadow-lg">
            Start Pro Trial
          </button>
        </div>
